...
export class GroupService {
  ...
  private async nameConflictCheck(newName: string | undefined, name: string | undefined, groupId: string): Promise<boolean> {
  ...
  async updateGroup(groupId: string, updateData: UpdateGroupDto): Promise<Group> {
    ...
    if (Object.prototype.hasOwnProperty.call(updateData, 'name') && updateData.name !== group.name) {
